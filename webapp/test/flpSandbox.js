		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ProcedimientoseInstructivos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ProcedimientoseInstructivos-display": {
								"semanticObject": "ProcedimientoseInstructivos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=profertil.instructivos",
									"url": sap.ui.require.toUrl("profertil/instructivos")
								}
							}
						}
					}
